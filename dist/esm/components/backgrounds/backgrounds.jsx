            ...
            switch (_e.label) {
                ...
                case 1:
                    ...
                    if ((_a = bgColorStyle === null || bgColorStyle === void 0 ? void 0 : bgColorStyle.css) === null || _a === void 0 ? void 0 : _a.light) {
                        backgrounds.push(<div className={"absolute inset-0 m-auto max-w-xs h-[357px] blur-[118px] sm:max-w-md md:max-w-lg ".concat(lightClassName)} style={(_b = bgColorStyle === null || bgColorStyle === void 0 ? void 0 : bgColorStyle.css) === null || _b === void 0 ? void 0 : _b.light}></div>);
                    }
