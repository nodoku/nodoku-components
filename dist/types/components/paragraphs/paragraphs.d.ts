...
import { I18nextProvider, NdCode, NdDefaultThemeName, NdList, NdTranslatableText, ThemeStyle } from "nodoku-core";
...
export declare class ParagraphsProps {
    ...
    constructor(lng: string, blockParagraphs: (NdTranslatableText | NdList | NdCode)[], paragraphStyle: ThemeStyle | undefined, codeHighlightTheme: HighlightedCodeThemeImpl, listTheme: ListCompThemeImpl, defaultThemeName: NdDefaultThemeName, i18nextProvider: I18nextProvider);
}
